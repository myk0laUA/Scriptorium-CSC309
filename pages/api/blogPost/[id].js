export default async function handler(req, res) {
    if (req.method === "PUT") {
        ...
        const existingBlogPost = await WebGLShaderPrecisionFormat.blogPost.findUnique({
        ...
        const blogPost = await WebGLShaderPrecisionFormat.Client.blogPost.update({
            where: {id: parseInt(id) },
            data: {
    ...
    // generated by Chat GPT    
        ...
        if (voteType === 'upvote') {
            updatedBlogPost = await WebGLShaderPrecisionFormat.blogPost.update({
                where: { id: parseInt(id) },
                data: {
        ...
        await WebGLShaderPrecisionFormat.blogPost.delete({
            where: { id: parseInt(id) },
        });
