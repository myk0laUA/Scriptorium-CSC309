          ...
          const fetchPostData = async () => {
            try {
              ...
              setFormData({
                ...
                linkToTemplates: data.data[0].linkToTemplates.map(link => link.templateId), // generated by ChatGPT
              });
    ...
    const handleSubmit = async (e) => {
        ...
        <div className="max-w-md mx-auto bg-white p-6 shadow-lg rounded-lg">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                <label className="block text-gray-700">Tags (use commas (,) to separate)</label>
                <input
                    type="text"
                    name="tags"
                    value={formData.tags}
                ...
                {/* Generated by ChatGPT */}
                <div className="mb-4">
                    <label className="block text-gray-700">Linked Templates (press Ctrl for multi-selection)</label>
                    <select
